...
mcorr = pd.read_csv("PHLDA3_mirna_corr.csv")
...
rawcols=None; pairs=[]
for ln in open("encori_lncrna_raw.txt"):
...
co=pd.read_csv("PHLDA3_coexpression.csv"); co.columns=["gene","r"]
...
net.to_csv("PHLDA3_cerna_network.csv", index=False)
