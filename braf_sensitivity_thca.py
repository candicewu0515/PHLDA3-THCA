...
br=pd.read_csv("PHLDA3_braf_ras.csv")[["patient","BRAF"]]
...
pd.DataFrame([{"model":"PHLDA3+age+sex+T",**base},{"model":"PHLDA3+age+sex+T+BRAF",**adj}]).to_csv("PHLDA3_braf_sensitivity.csv",index=False)
