...
# map symbols
m = pd.read_csv("data/thca_DE_full_symbol.csv")[["ensembl","symbol"]].dropna()
...
corr.to_csv("data/PHLDA3_coexpression.csv", header=["pearson_r"])
...
e.to_csv("data/PHLDA3_enrichr_GO_KEGG.csv", index=False)
...
g.to_csv("data/PHLDA3_GSEA_hallmark.csv", index=False)
