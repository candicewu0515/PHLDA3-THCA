...
anno = pd.read_csv("data/gse193581_anno.txt.gz", sep="\t", header=None, skiprows=1,
...
recs = []
for f in sorted(glob.glob("data/gse193581_raw/*_UMI.txt.gz")):
...
d.to_csv("data/PHLDA3_tumor_sc.csv", index=False)
