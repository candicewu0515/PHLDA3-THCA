...
enc = pd.read_csv("data/encori_phlda3_mirna.txt", sep="\t", comment="#")
...
mi = pd.read_csv("data/TCGA-THCA.mirna.tsv.gz", sep="\t", index_col=0)
...
res["sig"]=res["p"]<0.05
res.to_csv("data/PHLDA3_mirna_corr.csv", index=False)
