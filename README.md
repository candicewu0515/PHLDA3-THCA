...
| Fig 2 — N1 logistic + BRAF sensitivity + nomogram | `02_figure2_composite.py` (composite) ← `02_logistic_n1.py`, `02_braf_sensitivity.py`, `02_braf_stratified.py`, `02_nomogram_dca.py` |
