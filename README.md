...
> **An integrated multi-omics and single-cell bioinformatics analysis PHLDA3 marks kinase-driver-defined thyroid carcinoma: an integrated multi-omics and single-cell analysis.**
...
|---|---|
| Fig 1 — expression / validation / pan-cancer | `01_figure1_composite.py` (composite) ← `01_volcano.py`, `01_expression_roc.py`, `01_pancancer.py`, `01_geo_validation.py` |
...
| Fig 4 — immune + tumour-purity correction | `04_figure4_composite.py` (composite) ← `04_immune.py`, `04_purity_partialcorr.py` (+ `04_run_estimate.R`) |
